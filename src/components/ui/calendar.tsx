  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside:
          "day-outside text-white/40 opacity-50 aria-selected:bg-accent/50 aria-selected:text-white/50 aria-selected:opacity-30",
        day_disabled: "text-white/30 opacity-50",
        day_range_middle:
          "aria-selected:bg-accent/20 aria-selected:text-white",
