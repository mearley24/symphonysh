...
const PREWIRE: ProofSet = {
  ...
  photos: [
    ...
    {
      src: "/lovable-uploads/mounted-tvs/backbox-fp/IMG_0025.JPG",
      alt: "Backbox pre-wire above fireplace, conduit and low-voltage ready for finish",
      caption: "Conduit + low-voltage · ready for finish",
      projectSlug: "backbox-fireplace",
    },
    {
...
const WHOLE_HOME: ProofSet = {
  ...
  subhead:
    "Same mounting standard in every room. One rack feeds the house. The detail that tells you the same crew owned the whole job.",
  photos: [
    {
      src: "/lovable-uploads/home-theater/IMG_0979.JPG",
      alt: "Dedicated home theater with screen and surround speakers in Eagle-Vail",
      caption: "Dedicated theater · Eagle-Vail",
      projectSlug: "eagle-vail-theater",
    },
    {
      src: "/lovable-uploads/mounted-tvs/HP/IMG_0182.JPG",
      alt: "Multi-room TV install in a Highland Park residence",
      caption: "Multi-room · Highland Park",
    ...
    {
      src: "/lovable-uploads/mounted-tvs/backbox-fp/IMG_0027.JPG",
      alt: "Pre-construction backbox fireplace mount with TV flush against stone",
...
const MIXED_PORTFOLIO: ProofSet = {
  ...
  photos: [
    ...
    {
      src: "/lovable-uploads/mounted-tvs/frame-sonos/IMG_0030.JPG",
      alt: "Samsung Frame TV mounted with Sonos in a finished Edwards living room",
      caption: "Frame TV + Sonos · Edwards",
      projectSlug: "frame-sonos-combo",
    },
    {
      src: "/lovable-uploads/mounted-tvs/backbox-fp/IMG_0027.JPG",
    ...
    {
      src: "/lovable-uploads/mounted-tvs/wood-media/IMG_0510.JPG",
      alt: "Custom wood media wall with mounted TV and in-wall speakers",
      caption: "Custom wood media wall",
      projectSlug: "wood-media-wall",
    },
  ],
...
const LIGHTING_CONTROL: ProofSet = {
  ...
  photos: [
    ...
    {
      src: "/lovable-uploads/mounted-tvs/singletree-fp/IMG_1185.JPG",
      alt: "Singletree fireplace TV mount with concealed wiring in a finished room",
      caption: "Fireplace mount · finished room",
      projectSlug: "singletree-fireplace",
    },
    {
      src: "/lovable-uploads/home-theater/IMG_0958.JPG",
