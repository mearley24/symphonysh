        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              { title: "Home Automation", description: "Lighting control is a core pillar of the Control4 platform — scenes, keypads, and full integration.", path: "/services/home-integration" },
            ].map((s, i) => (
