    ...
    <PageBackground image={bgSecurity}>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-black/20 backdrop-blur-sm border-y border-white/5">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              { title: "Home Automation", description: "Security cameras and smart locks integrated into your whole-home Control4 automation system.", path: "/services/home-integration" },
              { title: "Home Networking", description: "A managed network keeps your cameras, access points, and smart locks online reliably.", path: "/services/networking" },
            ].map((s, i) => (
